        ...
        <div className="lg:pr-8">
          <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
            ...
            <p className="mt-4 text-lg text-gray-500 sm:mt-3">
              Wir würden uns freuen, von Ihnen zu hören! Senden Sie uns eine
              Nachricht über das nebenstehende Formular oder mailen Sie uns. Wir
              würden uns freuen, von Ihnen zu hören! Senden Sie uns eine eine
              Nachricht über das nebenstehende Formular, oder schreiben Sie uns
              eine E-Mail.
            </p>
            <form
              action="#"
