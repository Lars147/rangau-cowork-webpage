...
const Pricing = () => {
  ...
  return (
    <section className={`bg-background py-8`} id="pricing">
      <div className={`container mx-auto px-2 pt-4 pb-12 text-emerald-400`}>
        <h1
        ...
        <div className={`w-full mb-4`}>
          <div
            className={`h-1 mx-auto bg-emerald-400 w-64 opacity-25 my-0 py-0 rounded-t`}
          ></div>
        </div>
        <div
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                className={`h-1 w-full bg-emerald-400 my-0 py-0 rounded-t`}
              ></div>
          ...
          <div
            className={`flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-emerald-400 mt-4`}
          >
            <div
              className={`flex-1 bg-background text-gray-600 rounded-t rounded-b-none overflow-hidden shadow`}
            >
